...
public class VentanaSecundaria extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        //Se debe enviar dos argumentos al constructor del JDialog, desde que ventana se esta llamando, ya sea un JFrame o JDialog, y el otro argumento es el modal
        VentanaSecundariaJDialog ventanaSecundaria = new VentanaSecundariaJDialog(this, true);
        ventanaSecundaria.setVisible(true); //Mostramos la ventana secundaria cuando se haga click sobre el boton
