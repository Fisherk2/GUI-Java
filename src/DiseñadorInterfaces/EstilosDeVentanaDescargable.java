 ...
 * @author Fisher
 */
public class EstilosDeVentanaDescargable extends javax.swing.JFrame {

    /**
     * Creates new form Ventana
     */
    public EstilosDeVentanaDescargable() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        setTitle("Ventana con Diseñador Descargable");
    ...
    public static void main(String args[]) {
        //SIEMPRE EL ESTILO DE VENTANA DESCARGABLE DEBE PONERSE ANTES DE HACER VISIBLE LAS VENTANAS
        try {
            //Enviamos de argumento el nombre de la direccion de la clase del estilo de ventana que queremos establecer.
            UIManager.setLookAndFeel("com.jtattoo.plaf.hifi.HiFiLookAndFeel");

        } catch (ClassNotFoundException | InstantiationException | IllegalAccessException | UnsupportedLookAndFeelException ex) {
            System.out.println("EXCEPCION RELACIONADA CON EL LOOK AND FEEL");
        }
        
        /* Create and display the form */
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstilosDeVentanaDescargable().setVisible(true);
            }
        });
